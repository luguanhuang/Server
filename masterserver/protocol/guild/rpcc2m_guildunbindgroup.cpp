...
RPC_SERVER_IMPLEMETION(RpcC2M_GuildUnBindGroup, GuildUnBindGroupReq, GuildUnBindGroupRes)

void RpcC2M_GuildUnBindGroup::OnCall(const GuildUnBindGroupReq &roArg, GuildUnBindGroupRes &roRes)
{
...
void RpcC2M_GuildUnBindGroup::OnDelayReplyRpc(const GuildUnBindGroupReq &roArg, GuildUnBindGroupRes &roRes, const CUserData &roUserData)
{
