#ifndef __ArgentaTask_H__
#define __ArgentaTask_H__
...
class ArgentaTask : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "LevelRange", "TaskID", "Reward",  };
	...
	void CopyFrom(ArgentaTask  *pSrcTable)
	{
