#ifndef __PetItemTable_H__
#define __PetItemTable_H__
...
class PetItemTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "itemid", "petid",  };
	...
	void CopyFrom(PetItemTable  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[1]], row.petid)) return false; ++m_ColNum;
