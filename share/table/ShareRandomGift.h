#ifndef __ShareRandomGift_H__
#define __ShareRandomGift_H__
...
class ShareRandomGift : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "ID", "SceneType", "Prob",  };
	...
	void CopyFrom(ShareRandomGift  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[1]], row.SceneType)) return false; ++m_ColNum;
