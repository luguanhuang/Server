#ifndef __HeroBattleTips_H__
#define __HeroBattleTips_H__
...
class HeroBattleTips : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(HeroBattleTips  *pSrcTable)
	{
