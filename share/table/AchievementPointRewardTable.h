#ifndef __AchievementPointRewardTable_H__
#define __AchievementPointRewardTable_H__
...
class AchievementPointRewardTable : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(AchievementPointRewardTable  *pSrcTable)
	{
