#ifndef __PowerPointAdjustTable_H__
#define __PowerPointAdjustTable_H__
...
class PowerPointAdjustTable : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(PowerPointAdjustTable  *pSrcTable)
	{
