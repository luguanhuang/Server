#ifndef __LeagueRankReward_H__
#define __LeagueRankReward_H__
...
class LeagueRankReward : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(LeagueRankReward  *pSrcTable)
	{
