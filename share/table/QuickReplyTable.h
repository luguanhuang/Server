#ifndef __QuickReplyTable_H__
#define __QuickReplyTable_H__
...
class QuickReplyTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "ID", "Type", "Content",  };
	...
	void CopyFrom(QuickReplyTable  *pSrcTable)
	{
