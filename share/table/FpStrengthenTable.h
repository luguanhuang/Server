#ifndef __FpStrengthenTable_H__
#define __FpStrengthenTable_H__
...
class FpStrengthenTable : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(FpStrengthenTable  *pSrcTable)
	{
