#ifndef __TeamCostReward_H__
#define __TeamCostReward_H__
...
class TeamCostReward : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "DNExpeditionID", "Count", "Reward",  };
	...
	void CopyFrom(TeamCostReward  *pSrcTable)
	{
