#ifndef __BuyGoldTable_H__
#define __BuyGoldTable_H__
...
class BuyGoldTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "Level", "Gold", "DragonCoinCost", "DiamondCost",  };
	...
	void CopyFrom(BuyGoldTable  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[1]], row.Gold)) return false; ++m_ColNum;
