#ifndef __FirstPassReward_H__
#define __FirstPassReward_H__
...
class FirstPassReward : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(FirstPassReward  *pSrcTable)
	{
