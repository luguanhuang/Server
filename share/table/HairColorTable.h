#ifndef __HairColorTable_H__
#define __HairColorTable_H__
...
// generate by ProtoGen at date: 2017/6/14 10:03:24


class HairColorTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "ID", "Color", "Name", "Icon",  };
	...
	void CopyFrom(HairColorTable  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[1]], row.Color)) return false; ++m_ColNum;
