#ifndef __GuildBossRoleRewardTable_H__
#define __GuildBossRoleRewardTable_H__
...
class GuildBossRoleRewardTable : public CVSReader, public noncopyable
{
public:
	...
	struct RowData
	{
		...
		vector<Sequence<uint, 2>>	prestige;
	...
	void CopyFrom(GuildBossRoleRewardTable  *pSrcTable)
	{
