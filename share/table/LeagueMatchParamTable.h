#ifndef __LeagueMatchParamTable_H__
#define __LeagueMatchParamTable_H__
...
class LeagueMatchParamTable : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(LeagueMatchParamTable  *pSrcTable)
	{
