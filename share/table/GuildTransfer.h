#ifndef __GuildTransfer_H__
#define __GuildTransfer_H__
...
class GuildTransfer : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "id", "name", "description", "sceneid", "max", "icon",  };
	...
	void CopyFrom(GuildTransfer  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[4]], row.max)) return false; ++m_ColNum;
