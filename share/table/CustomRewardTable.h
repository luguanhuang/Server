#ifndef __CustomRewardTable_H__
#define __CustomRewardTable_H__
...
// generate by ProtoGen at date: 2017/5/9 10:17:57


class CustomRewardTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "id", "rank", "rewardshow", "rewarddrop", "boxcooldown", "boxquickopen",  };
	...
	void CopyFrom(CustomRewardTable  *pSrcTable)
	{
