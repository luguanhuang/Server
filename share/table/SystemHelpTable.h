#ifndef __SystemHelpTable_H__
#define __SystemHelpTable_H__
...
class SystemHelpTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "SystemID", "SystemDescription", "SystemHelp",  };
	...
	void CopyFrom(SystemHelpTable  *pSrcTable)
	{
	...
	virtual bool OnLine(char **Fields, int FieldCount)
	{
		...
		if (!Parse(Fields[m_ColMap[1]], row.SystemDescription)) return false; ++m_ColNum;
		if (!Parse(Fields[m_ColMap[2]], row.SystemHelp)) return false; ++m_ColNum;
