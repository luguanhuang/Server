#ifndef __InvitationTable_H__
#define __InvitationTable_H__
...
class InvitationTable : public CVSReader, public noncopyable
{
public:
	...
	{
		const char *Headers[] = { "ID", "Channel", "Content", "Desc",  };
	...
	void CopyFrom(InvitationTable  *pSrcTable)
	{
