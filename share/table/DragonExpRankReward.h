#ifndef __DragonExpRankReward_H__
#define __DragonExpRankReward_H__
...
class DragonExpRankReward : public CVSReader, public noncopyable
{
public:
	...
	void CopyFrom(DragonExpRankReward  *pSrcTable)
	{
